...
export const EPITHALON: MoleculeConfig = {
  slug: "epithalon",
  name: "Epithalon",
  aliases: ["Epitalon", "AEDG peptide"],
  group: "Longevity",
  goals: ["anti-aging"],
  seoTitle: "Epithalon Peptide: Uses, Evidence & Safety",
  metaDescription:
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Explored for its proposed role in normalizing melatonin secretion and circadian timing, particularly in the context of age-related decline in nighttime melatonin.",
    },
    {
      heading: "Antioxidant & neuroendocrine support",
      desc: "Studied in animal and laboratory models for effects on oxidative-stress markers and pineal-axis signaling; framed here as a research rationale, not a proven clinical benefit.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "In published protocols it is most often given as a short course of subcutaneous injections, sometimes repeated once or twice a year. The exact dose, route, and schedule are individualized by the prescribing physician; we present this as clinical context rather than a self-dosing guide.",
    },
    {
      question: "Is Epithalon safe?",
      answer:
        "In the reported studies it has generally been well tolerated, with side effects that are mild and uncommon. The human safety data are limited, however, so we screen for contraindications such as active cancer and pregnancy, use only pharmacy-grade product, and monitor throughout treatment.",
    },
  ],
  citations: [
    {
      id: 1,
      text: "Khavinson VK, et al. Peptide promotes overcoming of the division limit in human somatic cell. Bull Exp Biol Med. 2004.",
      url: "https://pubmed.ncbi.nlm.nih.gov/15340556/",
    },
    {
      id: 2,
      text: "Anisimov VN, et al. Effect of Epitalon on biomarkers of aging, life span and spontaneous tumor incidence in female mice. Biogerontology. 2003.",
      url: "https://pubmed.ncbi.nlm.nih.gov/14618027/",
    },
    {
      id: 3,
      text: "Khavinson VK, et al. Effect of Epithalamin and Epitalon on the lifespan and mortality of older patients: long-term follow-up. Bull Exp Biol Med. 2003.",
      url: "https://pubmed.ncbi.nlm.nih.gov/12937680/",
    },
  ],
  regulatoryNote:
