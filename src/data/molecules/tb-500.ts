...
export const TB_500: MoleculeConfig = {
  slug: "tb-500",
  name: "TB-500",
  ...
  primaryUse: "Soft-tissue, tendon, and muscle recovery",
  ...
  usedFor: [
    {
      heading: "Tendon & ligament injury",
      desc: "A common reason patients ask about TB-500 — supporting recovery from strains, partial tears, and stubborn tendinopathy where progress has stalled with rest and physical therapy.",
    },
    {
      heading: "Muscle & soft-tissue recovery",
      desc: "Supporting repair after muscle injury and overuse in active patients, typically alongside a structured rehabilitation program rather than as a replacement for one.",
    },
    {
      heading: "Joint & arthritic pain",
      desc: "Used within a joint-support protocol for its proposed anti-inflammatory and tissue-remodeling effects; frequently paired with BPC-157.",
    },
    {
      heading: "Flexibility & range of motion",
      desc: "Studied for its effects on connective tissue and scar remodeling, which some protocols aim to translate into improved mobility around a recovering joint.",
    },
  ],
  evidence: [
  ...
  faqs: [
    {
      ...
      answer:
        "No. TB-500 is not an FDA-approved drug. In the United States it is available only as a pharmacy-compounded preparation prescribed under physician supervision. Strong Health works exclusively with licensed 503A and 503B compounding pharmacies — never research-only or gray-market product.",
    },
    {
      question: "What is the difference between TB-500 and Thymosin Beta-4?",
      answer:
        "Thymosin Beta-4 (Tβ4) is the full naturally occurring protein; TB-500 is a synthetic peptide based on its short actin-binding region, the fragment thought to drive much of the parent protein's regenerative activity. In practice the names are often used interchangeably, but they are not identical molecules.",
    },
    {
      question: "How long does TB-500 take to work?",
      answer:
        "It varies by injury and individual. Some patients report changes in soreness and function within the first few weeks of a course, while tendon and ligament remodeling takes longer. Because robust human trials are lacking, we set expectations conservatively and judge response on your actual recovery, tracked at scheduled physician reviews.",
    },
    {
      question: "Can TB-500 be combined with BPC-157?",
      answer:
        "Yes, and it frequently is. TB-500 and BPC-157 are often used together in healing protocols because their proposed mechanisms are complementary — TB-500 emphasizes cell migration and tissue remodeling, BPC-157 emphasizes angiogenesis and gut protection. Any combination should be designed and monitored by a physician.",
    },
    {
  ...
  citations: [
    {
      id: 1,
      text: "Goldstein AL, Hannappel E, Sosne G, Kleinman HK. Thymosin β4: a multi-functional regenerative peptide. Basic properties and clinical applications. Expert Opin Biol Ther. 2012.",
      url: "https://pubmed.ncbi.nlm.nih.gov/22449052/",
    },
    {
      id: 2,
      text: "Xu TJ, Wang Q, Ma XW, et al. A role for thymosin β4 in the regulation of tendon healing and cell migration. Various models. Int J Mol Sci / related reviews. 2018.",
      url: "https://pubmed.ncbi.nlm.nih.gov/29695020/",
    },
    {
      id: 3,
      text: "Sosne G, Qiu P, Goldstein AL, Wheater M. Biological activities of thymosin β4 defined by active sites in short peptide sequences. FASEB J. 2010.",
      url: "https://pubmed.ncbi.nlm.nih.gov/20495177/",
    },
  ],
  regulatoryNote:
