...
export const BPC_157: MoleculeConfig = {
  slug: "bpc-157",
  name: "BPC-157",
  ...
  primaryUse: "Tendon, ligament, and soft-tissue healing",
  ...
  usedFor: [
    {
      ...
      desc: "The most common reason patients ask about BPC-157 — recovery from strains, partial tears, and chronic tendinopathy that has plateaued with rest and physical therapy.",
    },
    {
      heading: "Muscle & soft-tissue recovery",
      desc: "Supporting recovery from muscle injury and overuse in active patients, typically alongside a structured rehab program rather than in place of one.",
    },
    {
      heading: "Joint & arthritic pain",
      desc: "Used as part of a joint-support protocol for its proposed anti-inflammatory and tissue-repair effects; frequently paired with TB-500.",
    },
    {
      heading: "Gastrointestinal support",
      desc: "Studied for its protective effect on the gut lining, including in the context of NSAID-related irritation.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "Is BPC-157 a steroid or hormone?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Sikiric P, et al. Stable gastric pentadecapeptide BPC 157 in the treatment of tendon, ligament and muscle healing. Curr Pharm Des. 2018.",
      url: "https://pubmed.ncbi.nlm.nih.gov/29345863/",
    },
    {
      id: 2,
      text: "Chang CH, et al. The promoting effect of pentadecapeptide BPC 157 on tendon healing involves tendon fibroblasts and the VEGF/VEGFR2 pathway. J Appl Physiol. 2011.",
      url: "https://pubmed.ncbi.nlm.nih.gov/21030672/",
    },
    {
      id: 3,
      text: "Seiwerth S, et al. BPC 157 and standard angiogenic growth factors: gastrointestinal tract healing and cytoprotection. Curr Pharm Des. 2018.",
      url: "https://pubmed.ncbi.nlm.nih.gov/29424296/",
    },
  ],
  regulatoryNote:
