...
export const GHK_CU: MoleculeConfig = {
  slug: "ghk-cu",
  name: "GHK-Cu",
  ...
  primaryUse: "Skin, collagen, and tissue-repair copper peptide",
  ...
  usedFor: [
    {
      heading: "Skin aging & appearance",
      desc: "The most common reason people seek out GHK-Cu — topical use aimed at firmness, fine lines, and overall skin quality as natural peptide levels decline with age.",
    },
    {
      heading: "Collagen & elastin support",
      desc: "Used to support the skin's structural proteins by stimulating fibroblast activity and matrix remodeling, typically as a topical serum applied over time.",
    },
    {
      heading: "Wound healing & tissue repair",
      desc: "Studied for its role in supporting the repair of skin and soft tissue, drawing on its effects on angiogenesis and extracellular-matrix synthesis.",
    },
    {
      heading: "Hair & scalp support",
      desc: "Explored in topical formulations for the scalp for its proposed effects on the follicular environment and local tissue remodeling.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "Is GHK-Cu a steroid or hormone?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Pickart L, Margolina A. Regenerative and protective actions of the GHK-Cu peptide in the light of the new gene data. Int J Mol Sci. 2018.",
      url: "https://pubmed.ncbi.nlm.nih.gov/30049948/",
    },
    {
      id: 2,
      text: "Pickart L, Vasquez-Soltero JM, Margolina A. GHK peptide as a natural modulator of multiple cellular pathways in skin regeneration. Biomed Res Int. 2015.",
      url: "https://pubmed.ncbi.nlm.nih.gov/26236730/",
    },
    {
      id: 3,
      text: "Pickart L, Vasquez-Soltero JM, Margolina A. GHK and DNA: resetting the human genome to health. Biomed Res Int. 2014.",
