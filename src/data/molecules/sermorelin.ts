...
export const SERMORELIN: MoleculeConfig = {
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Used as part of a protocol aimed at improved recovery, lean-mass support, and reduced fat mass, typically alongside training, sleep, and nutrition rather than in place of them.",
    },
    {
      heading: "Sleep quality",
      desc: "Because much of natural GH release occurs during deep sleep, some patients report improvements in sleep quality on a GHRH-based protocol.",
    },
    {
      heading: "Adjunct to other secretagogues",
      desc: "Frequently paired with a GH-releasing peptide such as ipamorelin, which acts on a separate receptor, for a complementary effect on GH release under physician oversight.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Injected HGH supplies growth hormone directly, overriding your body's normal control. Sermorelin instead stimulates your own pituitary to release GH in its natural, pulsatile rhythm, so output stays subject to your body's feedback loops. That mechanism is why it's viewed as a more physiologic approach, though it also depends on a functioning pituitary to work.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, and it frequently is. Sermorelin acts on the GHRH receptor while ipamorelin acts on the separate ghrelin/GH-secretagogue receptor, so the two can produce a complementary effect on GH release. Any combination should be designed and monitored by a physician, with periodic IGF-1 checks.",
    },
    {
      question: "Is sermorelin safe?",
      answer:
        "Sermorelin has a relatively well-characterized safety profile from its history as an approved drug, and because it works through the pituitary with intact feedback it is generally considered lower-risk than injected HGH. Side effects are usually mild, most commonly injection-site irritation or flushing. We still screen for contraindications such as active cancer and pregnancy, use only pharmacy-grade product, and monitor IGF-1 throughout.",
    },
  ],
  citations: [
    {
      id: 1,
      text: "Prakash A, Goa KL. Sermorelin: a review of its use in the diagnosis and treatment of children with idiopathic growth hormone deficiency. BioDrugs. 1999.",
      url: "https://pubmed.ncbi.nlm.nih.gov/18020601/",
    },
    {
      id: 2,
      text: "Walker RF. Sermorelin: a better approach to management of adult-onset growth hormone insufficiency? Clin Interv Aging. 2006.",
      url: "https://pubmed.ncbi.nlm.nih.gov/18046911/",
    },
    {
      id: 3,
      text: "Khorram O, et al. Effects of a growth hormone-releasing hormone analog on the body composition and endocrine function of older adults. J Clin Endocrinol Metab. 1997.",
      url: "https://pubmed.ncbi.nlm.nih.gov/9177380/",
    },
  ],
  regulatoryNote:
