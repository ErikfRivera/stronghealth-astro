...
export const SELANK: MoleculeConfig = {
  slug: "selank",
  name: "Selank",
  ...
  primaryUse: "Anxiolytic and cognitive-support peptide (anxiety/cognition context)",
  ...
  usedFor: [
    {
      ...
      desc: "The most common reason patients ask about Selank — day-to-day anxiety, tension, and stress reactivity, where a non-sedating agent that does not carry dependence risk is appealing.",
    },
    {
      heading: "Sleep disrupted by anxiety",
      desc: "Used in the context of a racing, anxious mind that interferes with falling or staying asleep; here Selank is aimed at the underlying anxiety rather than acting as a direct sedative or sleep drug.",
    },
    {
      heading: "Cognition & focus",
      desc: "Explored for attention, mental clarity, and cognitive endurance under stress, on the strength of its proposed BDNF and monoamine effects.",
    },
    {
      heading: "Mood & resilience",
      desc: "Studied as part of a broader support plan for low mood and stress-related fatigue, framed as an adjunct rather than a replacement for established mental-health care.",
    },
  ],
  evidence: [
  ...
  faqs: [
    {
      ...
      answer:
        "No. Selank is not an FDA-approved drug in the United States. It has been used clinically in Russia, but here it is available only as a pharmacy-compounded preparation prescribed under physician supervision. Strong Health works exclusively with licensed 503A and 503B compounding pharmacies — never research-only or gray-market product.",
    },
    {
      question: "Is Selank a sedative or a sleeping pill?",
      answer:
        "No. Selank is studied as a non-sedating anxiolytic — it aims to lower anxiety rather than to sedate you. Where it may help with sleep, it does so indirectly, by calming the anxious, racing mind that keeps some people awake, rather than acting as a direct sleep drug.",
    },
    {
      question: "Is Selank addictive like benzodiazepines?",
      answer:
        "The available research reports no sedation, dependence, or withdrawal with Selank, which is one reason it draws interest as an alternative to benzodiazepines for anxiety. That said, the human data are limited, so we still prescribe it carefully, coordinate with any existing treatment, and monitor your response.",
    },
    {
      question: "How strong is the evidence for Selank?",
      answer:
        "It is early. Most data are preclinical, supported by a smaller set of Russian clinical studies — including one reporting it was comparable to a benzodiazepine for anxiety. What is missing is large, independent, placebo-controlled replication, so we frame Selank as promising but not definitively proven and set expectations conservatively.",
    },
    {
      question: "How is Selank taken?",
      answer:
        "Most commonly as an intranasal spray, which delivers the peptide without injection; subcutaneous forms have also been studied. The exact dose, route, and course length are individualized by your prescribing physician — we present administration as clinical context, not a self-dosing guide.",
    },
  ],
  citations: [
    {
      id: 1,
      text: "Zozulya AA, et al. Efficacy and safety of Selank in the therapy of patients with generalized anxiety disorder and neurasthenia. Zh Nevrol Psikhiatr Im S S Korsakova. 2008.",
      url: "https://pubmed.ncbi.nlm.nih.gov/18517033/",
    },
    {
      id: 2,
      text: "Volkova A, et al. Selank administration affects the expression of some genes involved in GABAergic neurotransmission and immune responses in the rat hippocampus. Front Pharmacol. 2016.",
      url: "https://pubmed.ncbi.nlm.nih.gov/26869924/",
    },
    {
      id: 3,
      text: "Kost NV, et al. Semax and selank inhibit the enkephalin-degrading enzymes from human serum. Bioorg Khim. 2001.",
      url: "https://pubmed.ncbi.nlm.nih.gov/11558266/",
    },
  ],
  regulatoryNote:
