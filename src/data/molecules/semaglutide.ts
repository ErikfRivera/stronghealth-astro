...
export const SEMAGLUTIDE: MoleculeConfig = {
  slug: "semaglutide",
  name: "Semaglutide",
  aliases: ["Ozempic", "Wegovy", "Rybelsus"],
  group: "Metabolic & GLP-1",
  goals: ["weight-loss", "belly-fat"],
  seoTitle: "Semaglutide: Weight Loss Uses & Evidence",
  metaDescription:
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Weight loss on semaglutide preferentially reduces visceral fat, the metabolically active fat linked to cardiometabolic risk.",
    },
    {
    ...
    },
    {
      ...
      desc: "Semaglutide has shown cardiovascular benefit in high-risk patients in dedicated outcome trials.",
    },
  ],
  evidence: [
  ...
  faqs: [
    {
      ...
      answer:
        "Yes. Semaglutide is FDA-approved for chronic weight management under the brand name Wegovy (for adults with obesity, or overweight with a weight-related condition), and separately for type 2 diabetes as Ozempic and Rybelsus. Strong Health prescribes it within a physician-supervised program.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Trial data show that much of the lost weight returns after discontinuation, because the underlying appetite and metabolic effects depend on the medication. We discuss maintenance strategy up front so stopping is a planned clinical decision, not an abrupt one.",
    },
    {
      question: "Is compounded semaglutide the same as Wegovy or Ozempic?",
      answer:
        "No. Wegovy and Ozempic are FDA-approved, manufactured products. Compounded semaglutide is a separate regulatory category tied to drug-shortage status and state pharmacy rules, and its availability changes over time. Strong Health prioritizes FDA-approved product and will explain exactly what is being prescribed and why.",
    },
    {
      question: "Who should not take semaglutide?",
      answer:
        "Semaglutide carries a boxed warning regarding thyroid C-cell tumors, so it is contraindicated in people with a personal or family history of medullary thyroid carcinoma or MEN 2. It should be used cautiously with a history of pancreatitis and is not used in pregnancy. We screen for these before prescribing.",
    },
  ],
  citations: [
    {
    ...
    {
      id: 2,
      text: "Davies M, et al. Semaglutide 2.4 mg once a week in adults with overweight or obesity and type 2 diabetes (STEP 2). Lancet. 2021.",
      url: "https://pubmed.ncbi.nlm.nih.gov/33667417/",
    },
    {
      id: 3,
      text: "Lincoff AM, et al. Semaglutide and Cardiovascular Outcomes in Obesity without Diabetes (SELECT). N Engl J Med. 2023.",
