...
export const LL_37: MoleculeConfig = {
  slug: "ll-37",
  name: "LL-37",
  aliases: ["Cathelicidin antimicrobial peptide", "CAMP fragment"],
  group: "Healing & Repair",
  goals: ["healing"],
  seoTitle: "LL-37 Peptide: Uses, Evidence & Safety",
  metaDescription:
    "LL-37 is the human cathelicidin host-defense peptide studied for antimicrobial action and wound healing. Review its mechanism, evidence, and how we use it.",
  tagline:
  ...
  primaryUse: "Antimicrobial and tissue-repair host-defense peptide",
  ...
  usedFor: [
    {
      heading: "Antimicrobial host defense",
      desc: "The peptide's defining property — direct, broad-spectrum activity against bacteria, fungi, and some viruses at the barrier surfaces where infection starts.",
    },
    {
      heading: "Wound healing",
      desc: "Studied for its ability to promote re-epithelialization and tissue closure, including in the context of chronic or slow-healing wounds where the body's own LL-37 is deficient.",
    },
    {
      heading: "Angiogenesis & tissue repair",
      desc: "Proposed to support new blood-vessel formation and repair-cell recruitment at an injury site, complementing other healing peptides.",
    },
    {
      heading: "Immune modulation",
      desc: "Explored for its role in tuning the innate immune response — a double-edged property that must be weighed carefully given its links to inflammatory conditions.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "What does LL-37 actually do?",
      answer:
    ...
    {
      question: "Why does LL-37 have a 'dual' or 'double-edged' reputation?",
      answer:
    ...
    {
      question: "Is there human evidence that LL-37 works as a therapy?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Dürr UH, Sudheendra US, Ramamoorthy A. LL-37, the only human member of the cathelicidin family of antimicrobial peptides. Biochim Biophys Acta. 2006.",
      url: "https://pubmed.ncbi.nlm.nih.gov/16716248/",
    },
    {
      id: 2,
      text: "Vandamme D, Landuyt B, Luyten W, Schoofs L. A comprehensive summary of LL-37, the factotum human cathelicidin peptide. Cell Immunol. 2012.",
      url: "https://pubmed.ncbi.nlm.nih.gov/23246832/",
    },
    {
      id: 3,
      text: "Koczulla R, et al. An angiogenic role for the human peptide antibiotic LL-37/hCAP-18. J Clin Invest. 2003.",
      url: "https://pubmed.ncbi.nlm.nih.gov/12782669/",
    },
    {
      id: 4,
      text: "Carretero M, et al. In vitro and in vivo wound healing-promoting activities of human cathelicidin LL-37. J Invest Dermatol. 2008.",
