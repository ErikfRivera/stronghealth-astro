...
export const TIRZEPATIDE: MoleculeConfig = {
  slug: "tirzepatide",
  name: "Tirzepatide",
  aliases: ["Mounjaro", "Zepbound"],
  group: "Metabolic & GLP-1",
  goals: ["weight-loss", "belly-fat"],
  seoTitle: "Tirzepatide: Weight Loss Uses & Evidence",
  metaDescription:
    "Tirzepatide (Mounjaro, Zepbound) is a dual GIP/GLP-1 medication for weight loss. Review the mechanism, SURMOUNT evidence, and how Strong Health prescribes it.",
  tagline:
  ...
  primaryUse: "Dual GIP/GLP-1 medication for weight loss",
  ...
  usedFor: [
    {
      ...
      desc: "The primary reason patients ask about tirzepatide. As Zepbound it is FDA-approved for long-term weight management in adults with obesity, or overweight alongside a condition such as hypertension or dyslipidemia.",
    },
    {
      heading: "Visceral & belly fat",
      desc: "Trials show meaningful reductions in waist circumference and visceral adipose tissue, the metabolically active fat around the abdominal organs that drives cardiometabolic risk.",
    },
    {
      heading: "Type 2 diabetes",
      desc: "As Mounjaro it is FDA-approved to improve glycemic control in type 2 diabetes, where it consistently lowers HbA1c alongside weight loss.",
    },
    {
      heading: "Cardiometabolic risk factors",
      desc: "Weight loss on tirzepatide is frequently accompanied by improvements in blood pressure, lipids, and other metabolic markers, tracked as part of a supervised program.",
    },
  ],
  evidence: [
  ...
  faqs: [
    {
      ...
      answer:
        "Yes. Tirzepatide is FDA-approved as Zepbound for chronic weight management and as Mounjaro for type 2 diabetes. This makes it different from most peptides discussed on this site, which are compounded and not FDA-approved. Strong Health prioritizes the branded, approved product dispensed through licensed pharmacies.",
    },
    {
      question: "How is tirzepatide different from semaglutide?",
      answer:
        "Semaglutide (Ozempic, Wegovy) activates one receptor, GLP-1. Tirzepatide activates two — GIP and GLP-1. In head-to-head diabetes trials tirzepatide produced greater reductions in HbA1c and body weight, and obesity trials have shown among the largest average weight loss of any approved medication.",
    },
    {
      question: "How much weight can you lose on tirzepatide?",
      answer:
        "In the SURMOUNT-1 trial, adults without diabetes lost on average roughly 15% to 21% of body weight at the higher doses over 72 weeks, compared with about 3% on placebo. Individual results vary with dose, adherence, diet, and activity — which is why treatment is supervised and adjusted over time rather than fixed.",
    },
    {
      question: "What are the most common side effects?",
      answer:
        "The most common effects are gastrointestinal — nausea, diarrhea, constipation, and vomiting — usually mild to moderate and most noticeable during dose increases. Starting low and titrating slowly reduces them. More serious but rarer risks, including pancreatitis and gallbladder disease, are screened for and monitored.",
    },
    {
      question: "Who should not take tirzepatide?",
      answer:
        "Tirzepatide is not used in people with a personal or family history of medullary thyroid carcinoma or MEN 2, or during pregnancy or breastfeeding. It is used with caution in those with a history of pancreatitis or on insulin. A physician screens for these conditions before prescribing.",
    },
  ],
  citations: [
    {
    ...
    {
      id: 2,
      text: "Frías JP, et al. Tirzepatide versus semaglutide once weekly in patients with type 2 diabetes (SURPASS-2). N Engl J Med. 2021.",
      url: "https://pubmed.ncbi.nlm.nih.gov/34170647/",
    },
    {
      id: 3,
      text: "Garvey WT, et al. Tirzepatide once weekly for the treatment of obesity in people with type 2 diabetes (SURMOUNT-2). Lancet. 2023.",
