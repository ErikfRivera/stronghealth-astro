...
export const KISSPEPTIN: MoleculeConfig = {
  slug: "kisspeptin",
  name: "Kisspeptin",
  ...
  primaryUse: "Reproductive-axis and libido signaling peptide",
  ...
  usedFor: [
    {
      heading: "Reproductive-hormone signaling",
      desc: "Studied as a way to stimulate the body's own LH and FSH production by acting on the natural upstream trigger of the HPG axis, rather than replacing downstream hormones directly.",
    },
    {
      heading: "Libido & sexual response",
      desc: "Explored for effects on sexual desire and arousal, based on human imaging work showing kisspeptin modulates brain regions tied to sexual and emotional processing.",
    },
    {
      heading: "Low sexual desire",
      desc: "Investigated in early clinical studies of men and women with low sexual desire, where administration enhanced brain responses to sexual stimuli.",
    },
    {
  ...
  faqs: [
    ...
    {
      question: "Does kisspeptin increase libido?",
      answer:
    ...
    {
      question: "How is kisspeptin different from testosterone or PT-141?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Comninos AN, et al. Kisspeptin modulates sexual and emotional brain processing in humans. J Clin Invest. 2017.",
      url: "https://pubmed.ncbi.nlm.nih.gov/28218627/",
    },
    {
      id: 2,
      text: "Thurston L, et al. Effects of kisspeptin administration in women with hypoactive sexual desire disorder: a randomized clinical trial. JAMA Netw Open. 2022.",
      url: "https://pubmed.ncbi.nlm.nih.gov/35179588/",
    },
    {
      id: 3,
      text: "Abbara A, et al. Kisspeptin: a novel physiological trigger for oocyte maturation in in-vitro fertilisation treatment. Lancet. 2014.",
      url: "https://pubmed.ncbi.nlm.nih.gov/25467583/",
    },
  ],
  regulatoryNote:
