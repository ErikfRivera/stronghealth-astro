...
export const PT_141: MoleculeConfig = {
  slug: "pt-141",
  name: "PT-141",
  aliases: ["Bremelanotide", "Vyleesi"],
  group: "Sexual Health",
  goals: ["libido"],
  seoTitle: "PT-141 Peptide: Uses, Evidence & Safety",
  metaDescription:
    "PT-141 (bremelanotide) works on brain melanocortin pathways to raise sexual desire. FDA-approved as Vyleesi for premenopausal HSDD — see mechanism and safety.",
  tagline:
  ...
  primaryUse: "Sexual desire and arousal via central melanocortin pathways",
  ...
  usedFor: [
    {
      heading: "Low sexual desire in women (HSDD)",
      desc: "The FDA-approved use, as Vyleesi, is acquired, generalized hypoactive sexual desire disorder in premenopausal women — low desire that is distressing and not explained by another medical or relationship cause.",
    },
    {
      heading: "Low libido in men (off-label)",
      desc: "PT-141 is used off-label and compounded for men reporting low desire, sometimes when PDE5 inhibitors address erections but not drive. This use is not FDA-approved.",
    },
    {
      heading: "Arousal difficulty despite adequate erectile function",
      desc: "Because it works centrally, PT-141 is sometimes considered when desire and arousal — rather than blood flow — are the limiting factor. Any such use is individualized and physician-directed.",
    },
  ],
  evidence: [
  ...
  faqs: [
    {
      ...
      answer:
        "Yes, in one specific form. Bremelanotide is FDA-approved under the brand name Vyleesi for acquired, generalized hypoactive sexual desire disorder (HSDD) in premenopausal women. Its use in men and other contexts is off-label and, in the United States, typically dispensed as a pharmacy-compounded preparation under physician supervision.",
    },
    {
      question: "How is PT-141 different from Viagra or Cialis?",
      answer:
        "They work in different places. Viagra and Cialis are PDE5 inhibitors that improve blood flow to support an erection. PT-141 acts in the brain on melanocortin pathways that drive sexual desire and arousal itself. That is why it is sometimes considered when the limiting factor is desire rather than blood flow.",
    },
    {
      question: "How does PT-141 work?",
      answer:
        "PT-141 activates melanocortin receptors — chiefly the MC4 receptor — in the central nervous system, modulating the neural circuitry involved in sexual motivation and arousal. Because it works centrally rather than on blood vessels, it is dosed ahead of anticipated activity rather than to produce an immediate physical response.",
    },
    {
      question: "Does PT-141 work for men?",
      answer:
        "PT-141 is used off-label for men reporting low desire, sometimes alongside or after PDE5 inhibitors. The high-quality trial evidence, however, is in premenopausal women, where the FDA approval sits. Evidence in men is more limited, so we discuss that honestly and individualize any decision.",
    },
    {
      question: "What are the main side effects of PT-141?",
      answer:
        "Nausea is the most common and the leading reason people stop, followed by flushing, headache, and injection-site reactions. PT-141 also causes a temporary rise in blood pressure and drop in heart rate, so it is not used in people with uncontrolled hypertension or cardiovascular disease. Repeated use can darken the skin.",
    },
  ],
  citations: [
    {
      id: 1,
      text: "VYLEESI (bremelanotide injection) prescribing information. DailyMed, U.S. National Library of Medicine.",
      url: "https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=f1d0c1b5-2f39-4bad-a6a4-0066e3ad5dcf",
    },
    {
      id: 2,
      text: "Kingsberg SA, et al. Bremelanotide for the Treatment of Hypoactive Sexual Desire Disorder: Two Randomized Phase 3 Trials (RECONNECT). Obstet Gynecol. 2019.",
      url: "https://pubmed.ncbi.nlm.nih.gov/31599840/",
    },
    {
      id: 3,
      text: "Molinoff PB, et al. PT-141: a melanocortin agonist for the treatment of sexual dysfunction. Ann N Y Acad Sci. 2003.",
      url: "https://pubmed.ncbi.nlm.nih.gov/12817846/",
    },
  ],
  regulatoryNote:
