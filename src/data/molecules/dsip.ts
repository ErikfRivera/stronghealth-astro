...
export const DSIP: MoleculeConfig = {
  slug: "dsip",
  name: "DSIP",
  aliases: ["Delta Sleep-Inducing Peptide"],
  group: "Sleep",
  goals: ["sleep"],
  seoTitle: "DSIP Peptide: Sleep Uses & Evidence",
  metaDescription:
    "DSIP is a nonapeptide studied for deepening slow-wave sleep without sedation. Review its mechanism, the human evidence, and how Strong Health prescribes it.",
  tagline:
  ...
  primaryUse: "Deep-sleep architecture support without sedation",
  ...
  usedFor: [
    {
      heading: "Poor sleep quality & depth",
      desc: "The most common reason patients ask about DSIP — a sense of light, fragmented, or unrefreshing sleep despite adequate time in bed, where deeper slow-wave sleep seems to be lacking.",
    },
    {
      heading: "Disrupted sleep-wake rhythm",
      desc: "Explored as a gentle modulator for irregular schedules, shift-related disruption, or difficulty consolidating sleep, in place of a sedating hypnotic.",
    },
    {
      heading: "Stress-related sleep disturbance",
      desc: "Studied for its proposed effects on the stress-hormone axis, of interest when heightened stress physiology is interfering with restful sleep.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "Is DSIP a sedative or sleeping pill?",
      answer:
    ...
    {
      question: "How strong is the evidence that DSIP works?",
      answer:
    ...
    {
      question: "Will DSIP make me groggy the next day?",
      answer:
    ...
    {
      question: "Can DSIP replace treatment for a sleep disorder?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Graf MV, Kastin AJ. Delta-sleep-inducing peptide (DSIP): a review. Neurosci Biobehav Rev. 1984.",
      url: "https://pubmed.ncbi.nlm.nih.gov/6145143/",
    },
    {
      id: 2,
      text: "Schneider-Helmert D, Schoenenberger GA. Effects of DSIP in man. Multifunctional psychophysiological properties besides induction of natural sleep. Neuropsychobiology. 1983.",
      url: "https://pubmed.ncbi.nlm.nih.gov/6355836/",
    },
    {
      id: 3,
      text: "Kovalzon VM, Strekalova TV. Delta sleep-inducing peptide (DSIP): a still unresolved riddle. J Neurochem. 2006.",
