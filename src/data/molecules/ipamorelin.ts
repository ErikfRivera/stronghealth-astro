...
export const IPAMORELIN: MoleculeConfig = {
  slug: "ipamorelin",
  name: "Ipamorelin",
  aliases: ["NNC 26-0161"],
  group: "GH Secretagogues",
  goals: ["muscle-growth", "sleep", "anti-aging"],
  seoTitle: "Ipamorelin Peptide: Uses & Safety",
  metaDescription:
    "Ipamorelin is a selective GH-releasing peptide studied for lean mass, recovery, and sleep. Review its mechanism, evidence, and how Strong Health prescribes it.",
  tagline:
  ...
  primaryUse: "Selective GH release for lean mass, recovery, and sleep",
  ...
  usedFor: [
    {
      heading: "Lean muscle & body composition",
      desc: "The most common reason patients ask about ipamorelin — supporting lean-mass gains and fat loss by raising the body's own growth-hormone output, typically alongside training and adequate protein.",
    },
    {
      heading: "Recovery & training capacity",
      desc: "Used to support recovery from hard training and to help active and aging patients maintain workload, usually as one part of a broader performance and recovery plan.",
    },
    {
      heading: "Sleep quality",
      desc: "Growth hormone is released in the deepest stages of sleep; patients often pursue ipamorelin, dosed before bed, in hopes of supporting deeper, more restorative sleep.",
    },
    {
      heading: "Healthy aging",
      desc: "Growth-hormone output declines with age, and ipamorelin is used within anti-aging protocols aimed at supporting body composition, energy, and recovery — under physician oversight.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "Does ipamorelin raise cortisol or make you hungry?",
      answer:
    ...
    {
      question: "Is ipamorelin the same as taking growth hormone?",
      answer:
    ...
    {
      question: "When is ipamorelin taken?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Raun K, et al. Ipamorelin, the first selective growth hormone secretagogue. Eur J Endocrinol. 1998.",
      url: "https://pubmed.ncbi.nlm.nih.gov/9849822/",
    },
    {
      id: 2,
      text: "Gobburu JV, et al. Pharmacokinetic-pharmacodynamic modeling of ipamorelin, a growth hormone releasing peptide, in human volunteers. Pharm Res. 1999.",
      url: "https://pubmed.ncbi.nlm.nih.gov/10554099/",
    },
    {
      id: 3,
      text: "Beck DE, et al. Ipamorelin plus standard of care reduces time to recovery of gastrointestinal function after bowel resection. Dis Colon Rectum. 2014.",
      url: "https://pubmed.ncbi.nlm.nih.gov/24401886/",
    },
  ],
  regulatoryNote:
