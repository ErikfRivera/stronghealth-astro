...
export const TESAMORELIN: MoleculeConfig = {
  slug: "tesamorelin",
  name: "Tesamorelin",
  aliases: ["Egrifta", "TH9507"],
  group: "GH Secretagogues",
  goals: ["belly-fat", "weight-loss"],
  seoTitle: "Tesamorelin: Visceral Fat Uses & Evidence",
  metaDescription:
    "Tesamorelin (Egrifta) is an FDA-approved GHRH analog that targets visceral belly fat. Review its evidence, safety, and how Strong Health prescribes it.",
  tagline:
  ...
  primaryUse: "Targeted reduction of visceral (belly) fat",
  ...
  usedFor: [
    {
      heading: "Visceral (belly) fat reduction",
      desc: "The core reason patients ask about tesamorelin — selectively lowering deep abdominal fat that resists diet and exercise, with the strongest human evidence of any GH secretagogue for this outcome.",
    },
    {
      heading: "HIV-associated lipodystrophy",
      desc: "Its FDA-approved indication: reducing excess abdominal fat accumulation in adults living with HIV, where the RCT data supporting approval were generated.",
    },
    {
      heading: "Metabolic & body-composition goals",
      desc: "Used off-label as part of a physician-supervised metabolic plan for adults with excess visceral adiposity, alongside nutrition and training rather than in place of them.",
    },
    {
      heading: "Age-related GH decline support",
      desc: "Sometimes considered within a broader growth-hormone-optimization protocol for its favorable, feedback-preserving mechanism — always under monitoring of IGF-1 and glucose.",
    },
  ],
  evidence: [
  ...
  faqs: [
    {
      ...
      answer:
        "Yes — for one specific indication. Tesamorelin (brand name Egrifta) is FDA-approved to reduce excess abdominal fat in adults with HIV-associated lipodystrophy. Using it for visceral-fat reduction in people without HIV is off-label. When compounded, Strong Health dispenses it only through licensed 503A and 503B pharmacies under physician supervision.",
    },
    {
      question: "How is tesamorelin different from growth hormone?",
      answer:
        "Tesamorelin does not replace growth hormone directly. It is a GHRH analog that stimulates your pituitary to release your own GH in a natural, pulsatile pattern, preserving the body's feedback control. This upstream mechanism is designed to avoid the sustained, supraphysiologic GH levels seen with injected growth hormone.",
    },
    {
      question: "Does tesamorelin cause weight loss?",
      answer:
        "Its signature effect is reducing visceral (deep abdominal) fat rather than lowering total body weight. In trials, waistline and visceral-fat measures fell even when overall weight changed little. It is not a general weight-loss drug and is not a substitute for a GLP-1 medication or lifestyle change.",
    },
    {
      question: "How long does tesamorelin take to work?",
      answer:
        "Visceral-fat changes typically develop over months of continued daily use, not weeks. Because the benefit tends to reverse after stopping, treatment is generally ongoing. We judge response by follow-up measures and labs, and set expectations conservatively.",
    },
    {
      question: "Is tesamorelin safe for people with diabetes?",
      answer:
        "It requires caution. By raising GH and IGF-1, tesamorelin can worsen insulin sensitivity and raise blood sugar. In people with diabetes or prediabetes we monitor glucose closely and weigh the risk individually. Anyone on tesamorelin should have glucose and IGF-1 checked on a schedule set by their physician.",
    },
  ],
  citations: [
    {
      id: 1,
      text: "Falutz J, et al. Metabolic effects of a growth hormone-releasing factor in patients with HIV. N Engl J Med. 2007;357(23):2359-2370.",
      url: "https://pubmed.ncbi.nlm.nih.gov/17916777/",
    },
    {
      id: 2,
      text: "Falutz J, et al. Effects of tesamorelin, a growth hormone-releasing factor, in HIV-infected patients with abdominal fat accumulation: a randomized placebo-controlled trial with a safety extension. J Acquir Immune Defic Syndr. 2010;53(3):311-322.",
      url: "https://pubmed.ncbi.nlm.nih.gov/20101189/",
    },
    {
      id: 3,
      text: "Stanley TL, et al. Effect of tesamorelin on visceral fat and liver fat in HIV-infected patients with abdominal fat accumulation: a randomized clinical trial. JAMA. 2014;312(4):380-389.",
      url: "https://pubmed.ncbi.nlm.nih.gov/25038357/",
    },
    {
      id: 4,
      text: "Egrifta (tesamorelin for injection) — FDA prescribing information, DailyMed.",
