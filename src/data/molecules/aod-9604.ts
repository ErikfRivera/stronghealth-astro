...
export const AOD_9604: MoleculeConfig = {
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Used by some patients aiming to shift body composition; we set expectations conservatively given the modest and mixed human evidence.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "Does AOD-9604 actually cause weight loss?",
      answer:
    ...
    {
      question: "How is AOD-9604 different from growth hormone?",
      answer:
    ...
    {
      question: "Does AOD-9604 affect blood sugar?",
      answer:
    ...
    {
      question: "Is AOD-9604 better than GLP-1 medications for weight loss?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Heffernan MA, et al. The effects of human GH and its lipolytic fragment (AOD9604) on lipid metabolism following chronic treatment in obese mice and β3-AR knock-out mice. Endocrinology. 2001.",
      url: "https://pubmed.ncbi.nlm.nih.gov/11713207/",
    },
    {
      id: 2,
      text: "Ng FM, et al. Metabolic studies of a synthetic lipolytic domain (AOD9604) of human growth hormone. Horm Res. 2000.",
      url: "https://pubmed.ncbi.nlm.nih.gov/11146367/",
    },
    {
      id: 3,
      text: "Stier H, Vos E, Kenley D. Safety and tolerability of the hexadecapeptide AOD9604 in humans, and review of its clinical development. J Endocrinol Diabetes Obes. 2013.",
    },
  ],
  regulatoryNote:
