...
export const CJC_1295: MoleculeConfig = {
  slug: "cjc-1295",
  name: "CJC-1295",
  aliases: ["CJC-1295 DAC", "Modified GRF (1-29)", "mod-GRF 1-29"],
  group: "GH Secretagogues",
  goals: ["muscle-growth", "anti-aging", "sleep"],
  seoTitle: "CJC-1295 Peptide: Uses, Evidence & Safety",
  metaDescription:
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Used to support recovery from training and everyday wear-and-tear, on the rationale that higher GH/IGF-1 aids protein synthesis and connective-tissue repair; typically alongside, not instead of, good training and nutrition.",
    },
    {
      heading: "Sleep quality",
      desc: "Because the largest natural GH pulse occurs during deep sleep, patients often report improved sleep depth; evening dosing is a common part of GH-secretagogue protocols.",
    },
    {
      heading: "Age-related GH decline",
      desc: "Explored as part of an anti-aging or 'GH optimization' plan in adults whose growth-hormone output has fallen with age, always under physician oversight and monitoring.",
    },
  ],
  evidence: [
  ...
  faqs: [
    ...
    {
      question: "Will CJC-1295 help me build muscle or lose fat?",
      answer:
  ...
  citations: [
    {
      id: 1,
      text: "Teichman SL, et al. Prolonged stimulation of growth hormone (GH) and insulin-like growth factor I secretion by CJC-1295, a long-acting analog of GH-releasing hormone, in healthy adults. J Clin Endocrinol Metab. 2006.",
      url: "https://pubmed.ncbi.nlm.nih.gov/16352683/",
    },
    {
      id: 2,
      text: "Ionescu M, Frohman LA. Pulsatile secretion of growth hormone (GH) persists during continuous stimulation by CJC-1295, a long-acting GH-releasing hormone analog. J Clin Endocrinol Metab. 2006.",
      url: "https://pubmed.ncbi.nlm.nih.gov/17062768/",
    },
    {
      id: 3,
      text: "Sackmann-Sala L, Ding J, Frohman LA, Kopchick JJ. Activation of the GH/IGF-1 axis by CJC-1295, a long-acting GHRH analog, results in serum protein profile changes in normal adult subjects. Growth Horm IGF Res. 2009.",
      url: "https://pubmed.ncbi.nlm.nih.gov/19546023/",
    },
  ],
  regulatoryNote:
