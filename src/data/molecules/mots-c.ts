...
export const MOTS_C: MoleculeConfig = {
  slug: "mots-c",
  name: "MOTS-c",
  ...
  usedFor: [
    ...
    },
    {
      ...
      desc: "Explored as part of a weight-management conversation for its proposed effects on fat metabolism and energy expenditure, always alongside diet, activity, and clinical oversight rather than as a standalone fat-loss agent.",
    },
    {
      heading: "Exercise capacity & recovery",
      desc: "Studied as an exercise-mimetic that may support metabolic adaptation; of interest to active patients, though human performance data are lacking.",
    },
    {
  ...
  citations: [
    {
      id: 1,
      text: "Lee C, et al. The mitochondrial-derived peptide MOTS-c promotes metabolic homeostasis and reduces obesity and insulin resistance. Cell Metab. 2015.",
      url: "https://pubmed.ncbi.nlm.nih.gov/25738459/",
    },
    {
      id: 2,
      text: "Reynolds JC, et al. MOTS-c is an exercise-induced mitochondrial-encoded regulator of age-dependent physical decline and muscle homeostasis. Nat Commun. 2021.",
      url: "https://pubmed.ncbi.nlm.nih.gov/33531486/",
    },
    {
      id: 3,
      text: "Kim KH, et al. Mitochondrial-derived peptides in aging and age-related diseases. Geroscience. 2021.",
      url: "https://pubmed.ncbi.nlm.nih.gov/33512648/",
    },
  ],
  regulatoryNote:
